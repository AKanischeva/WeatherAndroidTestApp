 ...
 */
public class MoscowWeatherFragment extends Fragment {

    private static MoscowWeatherFragment instance;
    ...
    public MoscowWeatherFragment() {
        compositeDisposable = new CompositeDisposable();
        Retrofit retrofit = RetrofitClient.getInstance();
        mService = retrofit.create(IOpenWeatherMap.class);
    }

    public static MoscowWeatherFragment getInstance() {
        if (instance == null) {
            instance = new MoscowWeatherFragment();
        }
        return instance;
    }

    public static MoscowWeatherFragment getNewInstance(){
        return new MoscowWeatherFragment();
    }
    ...
    private void getWeatherInformation() {
        compositeDisposable.add(mService.getWeatherByNameAndCountryCode(Common.MOSCOW,
